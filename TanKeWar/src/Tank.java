...
public class Tank {
	public static  int speedX = 7, speedY = 7; // 静态全局变量速度---------可以作为扩张来设置级别，速度快的话比较难
	public static int count = 0;
	public static final int width = 30, length = 30; // 坦克的全局大小，具有不可改变性
	...
	private int step = r.nextInt(10)+1 ; // 产生一个随机数,随机模拟坦克的移动路径
